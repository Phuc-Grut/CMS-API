...
public static class StringExtensions
{
    ...
    public static string KeywordStandardized(this string keyword)
    {
    ...
    public static string HtmlStandardized(this string html)
    {
        return html;
        // var dom = new HtmlDocument();

        // dom.OptionAutoCloseOnEnd = true; 
        // dom.OptionFixNestedTags = true; 
        // dom.LoadHtml(html);
        // dom.OptionDefaultUseOriginalName = true;
        //// dom.OptionOutputAsXml = true;
        //// dom.OptionXmlForceOriginalComment = true; 
        // return dom.DocumentNode.OuterHtml.Replace("><", "> <");
    }

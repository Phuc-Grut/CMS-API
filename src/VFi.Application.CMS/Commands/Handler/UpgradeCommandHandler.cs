...
internal class UpgradeCommandHandler : CommandHandler, IRequestHandler<UpgradeAddCommand, ValidationResult>,
                                                        IRequestHandler<UpgradeDeleteCommand, ValidationResult>,
                                                        IRequestHandler<UpgradeEditCommand, ValidationResult>,
                                                        IRequestHandler<UpgradeDuplicateCommand, ValidationResult>
{
    ...
    public async Task<ValidationResult> Handle(UpgradeAddCommand request, CancellationToken cancellationToken)
    {
        if (!request.IsValid(_contentRepository))
            return request.ValidationResult;
        var contentType = await _contentTypeRepository.GetByCode("Upgrade");
        ...
        var channel = await _groupCategoryRepository.GetByCode("Upgrade");
    ...
    public async Task<ValidationResult> Handle(UpgradeDeleteCommand request, CancellationToken cancellationToken)
    {
        if (!request.IsValid(_contentRepository))
            return request.ValidationResult;
    ...
    public async Task<ValidationResult> Handle(UpgradeEditCommand request, CancellationToken cancellationToken)
    {
        if (!request.IsValid(_contentRepository))
            return request.ValidationResult;
    ...
    public async Task<ValidationResult> Handle(UpgradeDuplicateCommand request, CancellationToken cancellationToken)
    {
        if (!request.IsValid(_contentRepository))
            return request.ValidationResult;
